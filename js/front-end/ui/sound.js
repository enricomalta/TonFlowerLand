...
function saveConfig () {
    ...
    if (configModal) {
        if (configModal.style.display === 'flex') {
            ...
            falaMascoteText.style.display = "flex";
            falaMascoteText2.style.display = "flex";
...
export function attachVolumeListeners() {
...
// Recolher Sound
export function soundRecolherPlanta() {
...
// Evento Click Mouse Classe Pointer
document.querySelectorAll(".pointer2").forEach(element => {
    element.addEventListener("click", soundClickMouse);
});
